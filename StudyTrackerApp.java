...
class StudyTracker
{
    ...
    public void ExportCSV()
    {
        ...
        catch(Exception eobj)
        {
            ...
            System.out.println("Report this issue.");
        }
    }
    ...
    public void SummaryByDate()
    {
        ...
        System.out.println("----------------------------------------------------");
        System.out.println("-- Summary By Date from Study Tracker App ---");
        System.out.println("----------------------------------------------------");
        ...
        do
        {
            ...
            switch(iChoice)
            {
                ...
                case 6:     // Exit the application
                    System.out.println("----------------------------------------------------");
                    System.out.println("Thank you for using Study Log application");
                    System.out.println("----------------------------------------------------");
                    break;
